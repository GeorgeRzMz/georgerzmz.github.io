...
<div class="card card-outline rounded-0 card-primary">
				...
				<div class="row">
					<div class="col-md-6">
						...
						<div class="custom-file custom-file-sm rounded-0">
							...
							<label class="custom-file-label rounded-0" for="customFile">Selleccione una imagen</label>
						</div>
					</div>
				</div>
				<div class="row">
	...
	<div class="card-footer">
			<div class="col-md-12">
				<div class="row">
					<button class="btn btn-sm btn-primary" form="manage-agent">Actualizar</button>
				</div>
			</div>
		</div>
</div>
