							...
							<td align="center">
								 <button type="button" class="btn btn-flat p-1 btn-default btn-sm dropdown-toggle dropdown-icon" data-toggle="dropdown">
				                  ...
				                  <div class="dropdown-menu" role="menu">
				                    <a class="dropdown-item edit_data" href="./?page=agents/manage_agent&id=<?= $row['id'] ?>" ><span class="fa fa-edit text-primary"></span> Editar</a>
...
<script>
	$(document).ready(function(){
		$('.delete_data').click(function(){
			_conf("¿Estás seguro de eliminar este agente de forma permanente?","delete_agent",[$(this).attr('data-id')])
		})
		$('.edit_data').click(function(){
			uni_modal("<i class='fa fa-edit'></i> Detalles del agente de actualización","agents/manage_agent.php?id="+$(this).attr('data-id'))
		})
		$('.table').dataTable({
			columnDefs: [
