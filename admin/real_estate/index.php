...
<div class="card card-outline rounded-0 card-primary">
	<div class="card-header">
		<h3 class="card-title">Lista de Bienes Raíces</h3>
				...
				<tbody>
					...
					?>
						<tr>
							...
							<td align="center">
								<a class="btn btn-default bg-gradient-light btn-flat btn-sm" href="?page=real_estate/view_estate&id=<?php echo $row['id'] ?>"><span class="fa fa-eye text-dark"></span> Ver</a>
