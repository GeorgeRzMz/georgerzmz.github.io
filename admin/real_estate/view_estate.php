...
<div class="content py-3">
    <div class="card card-outline card-primary rounded-0 shadow">
        <div class="card-header">
            <h4 class="card-title">Estado de Detalles: <b><?= isset($code) ? $code : "" ?></b></h4>
        </div>
        <div class="card-body">
                ...
                <div class="col-md-6">
                    ...
                    <fieldset>
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <span class="text-muted">Ubicación: </span><?= isset($location) ? $location : '' ?>
                            </div>
                            <div class="col-6">
                    ...
                    <fieldset>
                        ...
                        <?php endif; ?>
                        <?php else: ?>
                            <center><small class="text-mute"><i>No hay servicios listados.</i></small></center>
                        <?php endif; ?>
                    </fieldset>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-8 col-sm-12 col-xs-12">
                    <div class="card card-outline card-info rounded-0 shadow">
                        <div class="card-header">
                            <h4 class="cart-title"><b>Detalles de la agente:</b></h4>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-8">
                                    <dl>
                                        ...
                                        <dt class="text-muted"><b>N° celular</b></dt>
