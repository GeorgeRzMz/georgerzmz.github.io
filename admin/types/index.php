...
<div class="card card-outline rounded-0 card-primary">
	<div class="card-header">
		<h3 class="card-title">Lista de tipos de bienes raíces</h3>
...
<script>
	$(document).ready(function(){
		$('.delete_data').click(function(){
			_conf("¿Estás seguro de eliminar este tipo de bienes raíces de forma permanente?","delete_type",[$(this).attr('data-id')])
		})
		$('#create_new').click(function(){
			uni_modal("<i class='fa fa-plus'></i> Agregar nuevo tipo de inmueble","types/manage_type.php")
		})
		$('.view_data').click(function(){
			uni_modal("<i class='fa fa-eye'></i> Detalles del tipo de inmueble","types/view_type.php?id="+$(this).attr('data-id'))
		})
		$('.edit_data').click(function(){
			uni_modal("<i class='fa fa-edit'></i> Actualizar detalles del tipo de inmueble","types/manage_type.php?id="+$(this).attr('data-id'))
		})
		$('.table').dataTable({
			columnDefs: [
